...
const User = props => (
  <div className="single-user">
    ...
    <p>Over the next {props.daysRemaining} days, you can spend {props.remainingBudget / props.daysRemaining} per day or {props.remainingBudget} to achieve your savings target of {props.savingsTarget}.</p>
